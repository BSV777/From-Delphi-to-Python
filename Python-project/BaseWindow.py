...
class Ui_BaseWindow(object):
    ...
    def retranslateUi(self, BaseWindow):
        ...
        self.a_createbt.setStatusTip(_translate("BaseWindow", "Создать кнопку на форме", None))
        self.a_createed.setText(_translate("BaseWindow", "Создать &поле ввода", None))
        self.a_createed.setStatusTip(_translate("BaseWindow", "Создать поле ввода на форме", None))
        self.a_createlb.setText(_translate("BaseWindow", "Создать &надпись", None))
        self.a_createlb.setStatusTip(_translate("BaseWindow", "Создать надпись на форме", None))
        self.a_delobj.setText(_translate("BaseWindow", "У&далить объект", None))
        self.a_delobj.setStatusTip(_translate("BaseWindow", "Удалить выбранный объект", None))
